  ...
  return (
    <div className="px-6 py-8 bg-white">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-semibold text-gray-800">International Bestseller</h2>
     ...
     <div className='flex flex-col sm:flex-row mt-20 items-center justify-center gap-4 px-4'>
  <img 
    src="/Images/Grid/fictionbooks1.jpg" 
    alt="Fiction Book 1" 
    className='w-full sm:w-1/2 object-cover'
  />
  <img 
    src="/Images/Grid/fictionbooks2.jpg" 
    alt="Fiction Book 2" 
    className='w-full sm:w-1/2 object-cover'
  />
</div>
